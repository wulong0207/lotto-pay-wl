 ...
 * @version 1.0
 */
public class SZCardWapService extends PayAbstract {
	private Logger logger = LoggerFactory.getLogger(SZCardWapService.class);

	@Override
	public ResultBO<?> pay(PaymentInfoBO paymentInfo) {
		return SZCardUtil.toPay(paymentInfo, DivineConfig.SHENZHOU_CARD_WAP_PAY_URL);
	}
