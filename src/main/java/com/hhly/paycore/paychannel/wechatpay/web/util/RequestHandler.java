...
public class RequestHandler {
	...
	// 获取package的签名包
	public String genPackage(SortedMap<String, Object> packageParams) throws UnsupportedEncodingException {
	...
	public String createSign(SortedMap<String, Object> packageParams) {
		...
		String sign = Md5Util.md5_32(sb.toString()).toUpperCase();
		return sign;

	}

	public String createNotifySign(Map<String, String> map) {
		StringBuffer sb = new StringBuffer();
		Set es = map.entrySet();
		Iterator it = es.iterator();
		while (it.hasNext()) {
	...
	public boolean createMd5Sign(String signParams) {
		...
		String sign = Md5Util.md5_32(sb.toString()).toLowerCase();
	...
	/**  
	  ...
	  * @auth: xiongJinGang
	  * @param reqMap
	  * @time: 2017年5月2日 下午5:32:31
	  * @return: String 
	  */
	public String getSortParams(Map<String, String> reqMap) {
		...
		Collections.sort(mappingList, new Comparator<Map.Entry<String, String>>() {
			public int compare(Map.Entry<String, String> mapping1, Map.Entry<String, String> mapping2) {
				return mapping1.getKey().compareToIgnoreCase(mapping2.getKey());
			}
		});
		String init = "";
		...
		init += "key=" + WeChatPayConfig.keyapi;
		String sign = Md5Util.md5_32(init).toUpperCase();
