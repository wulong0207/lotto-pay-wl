...
public class AlipayNotify {
	...
	public static boolean verifyReturn(Map<String, String> params) {
		...
		// AlipayCore.logResult("wap",sWord);
	...
	public static boolean verifyNotify(Map<String, String> params) throws Exception {
		...
		// 写日志记录（若要调试，请取消下面两行注释）
		// String sWord = "responseTxt=" + responseTxt + "\n isSign=" + isSign + "\n 移动端支付返回回来的参数：" + AlipayCore.createLinkString(params);
		// AlipayCore.logResult("wap",sWord);
	...
	public static Map<String, String> decrypt(Map<String, String> inputPara) throws Exception {
		inputPara.put("notify_data", RSA.decrypt(inputPara.get("notify_data"), AlipayConfig.seller_private_key, AlipayConfig.input_charset));
		return inputPara;
	}
