package com.hhly.paycore.paychannel.alipay.web.util;
...
import com.hhly.paycore.httpClient.HttpProtocolHandler;
import com.hhly.paycore.httpClient.HttpRequest;
import com.hhly.paycore.httpClient.HttpResponse;
import com.hhly.paycore.httpClient.HttpResultType;
...
import com.hhly.paycore.sign.RSA;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
        	...
        	mysign = RSA.sign(prestr, AlipayConfig.seller_private_key, AlipayConfig.input_charset);
        }
		return mysign;
	}
	 ...
	 * @return 提交表单HTML文本
	 */
	public static String buildRequestActionUrl(Map<String, String> sParaTemp, String strMethod, String strButtonName, String actionUrl) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp);
		List<String> keys = new ArrayList<String>(sPara.keySet());
	 ...
	 * @return String 返回类型
	 */
	public static String buildRequest(String payGateway, Map<String, String> sParaTemp, String strMethod,
			String charset) {
		List<String> keys = new ArrayList<String>(sParaTemp.keySet());

		StringBuffer sbHtml = new StringBuffer();

		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + payGateway + "\""
