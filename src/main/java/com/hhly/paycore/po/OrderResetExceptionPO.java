 ...
 * @version 1.0
 */
public class OrderResetExceptionPO implements Serializable {
	private static final long serialVersionUID = 3068146141934830992L;
	private Integer id;//
	...
	public OrderResetExceptionPO() {
		super();
	}

	public OrderResetExceptionPO(String orderCode, Double aftBonus, Double totalCashBalance, Integer userId) {
		super();
		this.orderCode = orderCode;
		this.aftBonus = aftBonus;
		this.totalCashBalance = totalCashBalance;
		this.differenceBalance = MathUtil.sub(aftBonus, totalCashBalance);
		this.userId = userId;
	}
