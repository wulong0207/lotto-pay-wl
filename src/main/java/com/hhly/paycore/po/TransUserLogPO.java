 ...
 * @version 1.0
 */
public class TransUserLogPO implements Serializable {
	...
	public TransUserLogPO() {
		super();
	}

	public TransUserLogPO(Integer userId, String transCode, Short transType, String orderInfo) {
		super();
		this.userId = userId;
