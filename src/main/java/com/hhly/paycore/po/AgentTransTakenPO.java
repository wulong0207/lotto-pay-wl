 ...
 * @version 1.0
 */
public class AgentTransTakenPO extends BaseBO {
	...
	public AgentTransTakenPO() {
		super();
	}

	public AgentTransTakenPO(AgentTransTakenBO transTakenBO) {
		super();
		...
		this.agentId = transTakenBO.getAgentId();
