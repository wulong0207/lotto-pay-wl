...
@Service("iTransRedService")
public class TransRedServiceImpl implements ITransRedService {
	private static final Logger logger = LoggerFactory.getLogger(TransRedServiceImpl.class);
	@Resource
