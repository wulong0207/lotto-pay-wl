...
@Service("iTransRechargeService")
public class TransRechargeServiceImpl implements ITransRechargeService {

	public static final Logger logger = LoggerFactory.getLogger(TransRechargeServiceImpl.class);
	...
	*/
	...
	@Override
	public ResultBO<?> addRechargeTransList(UserInfoBO userInfo, PayParamVO payParam, String channelType) {
		...
		try {
			...
			String[] channels = channelType.split("_");
			PayChannelEnum payChannelEnum = PayConstants.PayChannelEnum.getByType(channels[0]);
